...
exports.handlePsqlErrors = (err, req, res, next) => {
  ...
  if (psqlCodes4.includes(err.code)) res.status(400).send({ msg: 'You can not have a null value in a column which has a non-null contraint' });
};
